...
contract CreditingSystem {
    ...
    uint256 interestCalc;
    uint256 futureBalCalc;
    ...
    function loanMoney(uint256 _loanAmount, uint256 _yearss) public returns (bool){
        if (_yearss == 1) {
            ...
            futureBalCalc = totalPayableCalc * 12;
            interestCalc = futureBalCalc - _loanAmount;
            return true;
            ...
            payableInteresetCalc = payablePerMonthCalc/interestRateCalc;
            totalPayableCalc = payablePerMonthCalc + payableInteresetCalc;
            futureBalCalc = totalPayableCalc * 24;
            interestCalc = futureBalCalc - _loanAmount;
            return true;
        } else {
            return false;
    ...
    function viewCalculatedLoan () public view returns (uint256, uint256, uint256, uint256) {
        return (loanAmount, interestCalc, futureBalCalc, totalPayableCalc);
    }
